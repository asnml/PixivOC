...
create_task = create_json('S2', 103, keyword='28145748', task_name='TestUserWorks', save_path='.')
...
print('SendType:', unit['SendType'])
print('TID:', unit['Content']['TID'])
for link in unit['Content']['Content']:
    print(link)
time.sleep(5)
