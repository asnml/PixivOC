...
|     TaskDetails      |  14  |                 TID                 |                    |         list<br />[] or [TaskDetails](#TaskDetails)          |
|    AllTaskDetails    |  15  |                                     |                    | list<br />[ [TaskDetails](#TaskDetails), [TaskDetails](#TaskDetails), ... ] |
|  AddWorkDetailsTask  | 101  | KeyWord<br />TaskName<br />SavePath |        True        | list<br />[ False, [] ] or <br />[ True, *[TaskDetails](#TaskDetails) ] |
|  AddSingleWorkTask   | 102  | KeyWord<br />TaskName<br />SavePath |       False        | list<br />[ False, [] ] or <br />[ True, *[TaskDetails](#TaskDetails) ] |
| AddUserWorksLinkTask | 103  | KeyWord<br />TaskName<br />SavePath |        True        | list<br />[ False, [] ] or <br />[ True, *[TaskDetails](#TaskDetails) ] |
|   AddUserWorksTask   | 104  | KeyWord<br />TaskName<br />SavePath |       False        | list<br />[ False, [] ] or <br />[ True, *[TaskDetails](#TaskDetails) ] |
...
&emsp;`TaskDetails` 是一个列表，其包含了一个任务的属性。
