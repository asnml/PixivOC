...
|     SetProxyMode     |  3   |        ProxyMode<br />Proxy         |                    | bool<br />Mean: operation is successful ? |
|      SetTimeout      |  4   |               Timeout               |                    | bool<br />Mean: operation is successful ? |
| SetConcurrencyNumber |  5   |          ConcurrencyNumber          |                    | bool<br />Mean: operation is successful ? |
|   SetIntervalTime    |  6   |            IntervalTime             |                    | bool<br />Mean: operation is successful ? |
|     SetIncrement     |  7   |              Increment              |                    | bool<br />Mean: operation is successful ? |
...
|  AddWorkDetailsTask  | 101  | KeyWord<br />TaskName<br />SavePath |        True        | bool<br />Mean: operation is successful ? |
|  AddSingleWorkTask   | 102  | KeyWord<br />TaskName<br />SavePath |       False        | bool<br />Mean: operation is successful ? |
| AddUserWorksLinkTask | 103  | KeyWord<br />TaskName<br />SavePath |        True        | bool<br />Mean: operation is successful ? |
|   AddUserWorksTask   | 104  | KeyWord<br />TaskName<br />SavePath |       False        | bool<br />Mean: operation is successful ? |
